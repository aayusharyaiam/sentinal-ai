          ...
          <section className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="bg-surface-container-low p-6 border border-tertiary/20 relative group overflow-hidden flex flex-col h-full">
              ...
              <div className="mt-auto space-y-4">
                ...
                <button className="w-full py-3 border border-tertiary text-tertiary font-headline text-[10px] tracking-widest hover:bg-tertiary hover:text-[hsl(36,100%,18%)] transition-all">
